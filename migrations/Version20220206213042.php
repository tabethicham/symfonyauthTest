 ...
 */
final class Version20220206213042 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE client (id INT AUTO_INCREMENT NOT NULL, ref_client VARCHAR(15) NOT NULL, email_client VARCHAR(255) NOT NULL, tel_client VARCHAR(15) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE devis (id INT AUTO_INCREMENT NOT NULL, client_id INT NOT NULL, ref_devis VARCHAR(15) NOT NULL, date_devis DATE NOT NULL, message_devis VARCHAR(255) NOT NULL, modalites_paiement_devis VARCHAR(255) NOT NULL, delai_devis VARCHAR(255) NOT NULL, INDEX IDX_8B27C52B19EB6921 (client_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
